...
export default function PlatformCard(props: PlatformCardProps) {
	...
	return (
		<a href={url} rel='noreferrer noopener' target='_blank'>
			<div className='mb-5 flex w-72 rounded-[4px] border border-border bg-primary-foreground p-3 transition-all hover:border-foreground/25 hover:shadow-sm'>
				...
				<div className='ml-3 grow font-semibold text-primary'>{username}</div>
